    ...
    return (
      <Sheet open={openMobile} onOpenChange={setOpenMobile} {...props}>
        <SheetContent
          ...
          data-mobile="true"
          side="bottom"
          className="max-h-[min(85dvh,36rem)] w-full overflow-hidden rounded-t-2xl border-t bg-sidebar p-0 text-sidebar-foreground [&>button]:hidden"
        >
          ...
          />
          <div className="flex max-h-[calc(min(85dvh,36rem)-0.75rem)] w-full flex-col overflow-y-auto">
            {children}
          </div>
        </SheetContent>
      </Sheet>
